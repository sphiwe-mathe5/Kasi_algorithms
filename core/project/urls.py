...
from core.views import index, subscribe, about, enquire,contact, terms, optout, nazire, PostListView, PostDetailView, PostCreateView,PostUpdateView,PostDeleteView, UserPostListView
